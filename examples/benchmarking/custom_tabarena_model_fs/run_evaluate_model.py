...
from bencheval.bencheval.website_format import format_leaderboard

if __name__ == "__main__":
    path_raw = Path(__file__).parent / "tabarena_out" / "Boruta_LightGBM"
    """Output directory for saving the results and result artifacts from TabArena."""

    fig_output_dir = Path(__file__).parent / "evals" / "Boruta_LightGBM"
    """Output for artefacts from the evaluation results of the custom model."""

    method = "Boruta_LightGBM"
    cache = True
