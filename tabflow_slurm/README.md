...
```bash
source /work/dlclarge2/purucker-tabarena/venvs/tabarena_25032026/bin/activate && cd /work/dlclarge2/purucker-tabarena/code/tabarena_new/tabarena/tabflow_slurm
```
