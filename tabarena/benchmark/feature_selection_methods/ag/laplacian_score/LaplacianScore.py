...
class LaplacianScore(AbstractFeatureSelector):
    ...
    def _fit_transform(self, X: DataFrame, y: Series, model, n_max_features: int, **kwargs) -> tuple[DataFrame, dict]:
        ...
        from tabarena.benchmark.feature_selection_methods.ag.laplacian_score.method.LaplacianScore import LaplacianScore
        self._laplacian_score = LaplacianScore(model)
        # Time limit
