...
class INTERACTFeatureSelector(AbstractFeatureSelector):
    ...
    Reference: Zhao, Zheng, and Huan Liu. "Searching for interacting features in subset selection." 
    Intelligent Data Analysis 13.2 (2009): 207-228.
    Implementation Inspiration: Information Gain code from  https://github.com/Thijsvanede/info_gain/blob/
